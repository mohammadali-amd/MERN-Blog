...
import { Paper, Typography, CircularProgress, Divider, CardActionArea, CardMedia, CardContent, Card } from '@material-ui/core';
            ...
            <div className={classes.section}>
               ...
               <div className={classes.recommendedPosts}>
                  {recommendedPosts.map(({ title, message, name, selectedFile, tags, _id }) => (
                     <Card className={classes.recommendedPost} raised elevation={6}>
